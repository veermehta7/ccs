...
<nav class="navbar navbar-expand-md bg-dark navbar-dark">
  <img src="iStock1.jpg" alt="" class="mr-3 mt-3 rounded-circle" style="width:45px;">
      <a class="navbar-brand" href="#">Update Contacts</a>
...
<tr>
      ...
      <tbody>
		...
		<td><?php echo $count ;?>
						...
						<td><a href="details1.php?sid=<?php echo  $data['id']; ?>">Edit</td>		
			...
			<td><font color="white"><img src="dataimg/<?php echo $data['photo']; ?>" style="max-width:10px;" /></font></td>
